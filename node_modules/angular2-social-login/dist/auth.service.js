                ...
                case "twitter":
                    IN.User.authorize(function () {
                        IN.API.Raw("/people/~:(id,first-name,last-name,email-address,picture-url)").result(function (res) {
                            var userDetails = { name: res.firstName + " " + res.lastName, email: res.emailAddress, uid: res.id, provider: "twitter", image: res.pictureUrl };
                            localStorage.setItem('_login_provider', 'twitter');
                            observer.next(userDetails);
                            observer.complete();
                        });
                    });
        ...
        return Observable.create(function (observer) {
            switch (provider) {
                case "google":
                    ...
                    let win = window.open(gSignout.src,"G+","width:200px; height: 200px;");             
                    break;
                case "facebook":
